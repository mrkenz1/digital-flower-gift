function ThemeSwitch({ isNightMode, onChange }) {
  return (
    <div className="theme-switch-wrap">
      <svg className="theme-switch-filters" aria-hidden="true">
        <defs>
      ...
      <label className="theme-switch" title={isNightMode ? "Day mode" : "Night mode"}>
        <input
